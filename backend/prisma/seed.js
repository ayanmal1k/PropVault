...
async function main() {
    ...
    ].map((a) => prisma.area.upsert({
        where: { cityId_slug: { cityId: a.cityId, slug: a.slug } },
        update: {},
        create: a,
    })));
    const types = await Promise.all([
        { name: "House", slug: "house", category: client_1.PropertyCategory.RESIDENTIAL },
        { name: "Flat", slug: "flat", category: client_1.PropertyCategory.RESIDENTIAL },
        { name: "Plot", slug: "plot", category: client_1.PropertyCategory.PLOT },
        { name: "Office", slug: "office", category: client_1.PropertyCategory.COMMERCIAL },
        { name: "Shop", slug: "shop", category: client_1.PropertyCategory.COMMERCIAL },
    ].map((t) => prisma.propertyType.upsert({
        where: { slug: t.slug },
        update: {},
        create: t,
    })));
    const amenities = await Promise.all(["Swimming Pool", "Gym", "Parking", "Security", "Garden", "Elevator", "Central AC", "Backup Generator"].map((name, i) => prisma.amenity.upsert({
    ...
    const sampleProperties = [
        {
            ...
            purpose: client_1.ListingPurpose.SALE,
            category: client_1.PropertyCategory.RESIDENTIAL,
            price: 32500000,
            bedrooms: 5,
            bathrooms: 4,
            areaSize: 5,
        ...
        },
        {
            ...
            purpose: client_1.ListingPurpose.SALE,
            category: client_1.PropertyCategory.PLOT,
            price: 45000000,
            areaSize: 2,
            areaUnit: "KANAL",
            cityId: lahore.id,
        ...
        },
        {
            ...
            purpose: client_1.ListingPurpose.RENT,
            category: client_1.PropertyCategory.RESIDENTIAL,
            price: 95000,
            rentPeriod: "monthly",
            bedrooms: 2,
    ...
    for (const p of sampleProperties) {
        await prisma.property.upsert({
            where: { slug: p.slug },
            update: { status: client_1.PropertyStatus.ACTIVE, publishedAt: new Date() },
            create: {
                ...p,
